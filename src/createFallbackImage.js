 ...
 */
function createFallbackImage(sharpDetails) {
    return __awaiter(this, void 0, void 0, function () {
        var sharpDetailsFinal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, createSources_1["default"])(sharpDetails)];
                case 1:
                    sharpDetailsFinal = (_a.sent()).sharpDetailsFinal;
                    return [2 /*return*/, sharpDetailsFinal];
            }
        });
    });
}
exports["default"] = createFallbackImage;
